...
export const CreateAMatchModal = ({ selectedDate, setIsCreateMatchModalOpen, tournament }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(formData.homeTeam && formData.awayTeam && formData.homeTeam === formData.awayTeam) validationErrors.awayTeam = "Home team and away teams must be different"
