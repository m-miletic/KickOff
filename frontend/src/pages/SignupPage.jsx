...
const SignupPage = () => {
  ...
  // useRef za razliku ode useState-a ne triggera re-render
  ...
  const handleRegistration = async (event) => {
    ...
    try {
      ...
      if (response.statusCode === 200) {
        ...
        alert("An error occured: " + (response.message || "Unknown error"));
      }
    } catch ( error ) {
  ...
  return (
    ...
    via-gray-400">
      <div className="flex shadow-2xl">
        <div className="flex flex-col bg-[#F7F7F7] items-center jusitfy-center text-center p-20 gap-8 rounded-2xllg:rounded-tr-none lg:rounded-br-none">
          ...
          <form onSubmit={handleRegistration}>
            ...
            <button className="px-10 py-2 text-2xl text-white rounded-md bg-gradient-to-tr bg-blue-500 mt-4
            hover:px-11 hover:py-2.5">
              Register
            </button>
          </form>
          <div>
            ...
            <div>
              <button data-modal-target="default-modal" data-modal-toggle="default-modal" className={`${isMobile ? "" : "hidden"} block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`} type="button">
                Why Register
              </button>
        ...
        {!isMobile && (
          <div className="relative">
            <img className="w-[450px] object-cover md:rounded-tr-2xl md:rounded-br-2xl lg:block hidden opacity-20" src={image} alt="" />
